...
// import '../../../src/style.css';
  ...
  return (
    ...
    <div className="">
        ...
        <img src="img/osib.png" alt="" className="w-full"/>
        <div className="py-10 lg:px-[10rem] sm:px-[2rem]">
        <img src="img/osi1.png" alt="" className="w-full"/>
        ...
        <div className="grid grid-cols-2 gap-6 mt-3">
            ...
            <div><img src="img/osi2.png" alt="" className="w-full"/></div>
        </div>

        <div className="grid grid-cols-2 gap-6 mt-3">
        <div><img src="img/osi3.png" alt="" className="w-full"/></div>
            <div>
