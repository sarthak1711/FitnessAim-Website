...
// import '../../../src/style.css';
  ...
  return (
    ...
    <div className="">
        ...
        <img src="img/supb.png" alt="" className="w-full"/>
        <div className="py-10 lg:px-[10rem] sm:px-[2rem]">
        <img src="img/sup1.png" alt="" className="w-full"/>
        ...
        <div className="grid grid-cols-2 gap-6 mt-3">
            ...
            <div><img src="img/sup2.png" alt="" className="w-full"/></div>
        </div>

        <div className="grid grid-cols-2 gap-6 mt-3">
        <div><img src="img/sup3.png" alt="" className="w-full"/></div>
            <div>
            ...
            <p className="text-[24px] font-semibold text-[#333333] pt-5">Tailored Support Plans </p>
            <p className="text-[16px] text-[#333333] py-5">Every gym is unique, and so are its support needs. At Fitness Aim, we offer tailored support plans designed to fit your specific requirements. Whether you run a small boutique studio or a large fitness center, we can customize our services to match your operational needs and budget. Our flexible plans ensure you get the right level of support to keep your gym thriving.</p>

            <p className="text-[24px] font-semibold text-[#333333] pt-5">Enhancing Member Experience</p>
            <p className="text-[16px] text-[#333333] py-5">A well-maintained gym not only operates efficiently but also enhances the overall member experience. At Fitness Aim, we understand that your members' satisfaction is paramount. By ensuring your equipment is always in top condition and your facility remains clean and inviting, we help you create an environment where members love to work out and stay committed to their fitness goals.</p>

            <p className="text-[24px] font-semibold text-[#333333] pt-5">Partner with Fitness Aim for Continuous Success</p>
            <p className="text-[16px] text-[#333333] py-5">At Fitness Aim, our mission is to support your gym’s success every day. With our continuous support and maintenance services, you can focus on growing your business and providing an exceptional experience for your members. Let us be your trusted partner in achieving long-term success and maintaining a top-performing fitness facility.</p>

            <p className="text-[24px] font-semibold text-[#333333] pt-5">Ready to Elevate Your Gym’s Performance? </p>
            <p className="text-[16px] text-[#333333] py-5">Contact Fitness Aim today to learn more about our continuous support and maintenance services. Together, we can ensure your gym remains at the pinnacle of performance, reliability, and member satisfaction.</p>
