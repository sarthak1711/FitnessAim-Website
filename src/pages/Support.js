...
// import '../../../src/style.css';
  ...
  return (
    ...
    <div className="">
        ...
        <div className="bg-[#f8f8f8] py-10 lg:px-[20rem] sm:px-[2rem] text-[40px] font-bold">Continuous Support & Maintenance: 
        Keeping Your Gym at Peak Performance </div>
        ...
        <div className="grid grid-cols-1 gap-6 mt-3">
            ...
            <p className="text-[24px] font-semibold text-[#333333] py-2">Tailored Support Plans </p>
            ...
            <p className="text-[24px] font-semibold text-[#333333] py-2">Enhancing Member Experience</p>
            ...
            <p className="text-[24px] font-semibold text-[#333333] py-2">Partner with Fitness Aim for Continuous Success</p>
            ...
            <p className="text-[24px] font-semibold text-[#333333] py-2">Ready to Elevate Your Gym’s Performance? </p>
