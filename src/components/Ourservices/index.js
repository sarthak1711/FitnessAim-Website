  ...
  return (
    <section className="pbg relative">
        ...
        <div className="w-full absolute top-0">
          ...
          <div className="grid grid-cols-4 gap-10 py-10 px-20">
            <div className="h-[400px] text-center p-7" style={{border: '1px solid #424242'}}>
              <p className="flex justify-center mt-3"><img src="img/os1.png" alt=""/></p>
              <p className="text-white text-[24px] mt-5">Premium 
              Equipment Supply</p>
              ...
              <hr/>
              <p className="text-[14px] text-white mt-2 cursor-pointer">Know More</p>
            </div>

            <div className="h-[400px] text-center p-5" style={{border: '1px solid #424242'}}>
              <p className="flex justify-center mt-4"><img src="img/os2.png" alt=""/></p>
              <p className="text-white text-[24px] mt-5">On-site
            ...
            <div className="h-[400px] text-center p-7" style={{border: '1px solid #424242'}}>
              ...
              <p className="text-white text-[24px] mt-5">Consultation &
              Custom Design </p>
            ...
            <div className="h-[400px] text-center p-5" style={{border: '1px solid #424242'}}>
              ...
              <p className="text-white text-[24px] mt-5"> Continuous Support & Maintenance </p>
