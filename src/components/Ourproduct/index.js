        ...
        <div className="w-full">
          ...
          <div className="grid lg:grid-cols-2 max-sm:grid-cols-1 gap-10 pt-20 pb-[10rem] lg:px-[5rem] max-sm:px-6">
            <div className="px-10 max-sm:px-2">
              <img src="img/opimg.png" alt="" className="w-full h-full"/>
            </div>
            ...
            <p className="text-white text-[18px] my-2">Empowering athletes to achieve their sporting dreams, from national competitions to the Olympic Games. We provide comprehensive support and world-class, Indian-made equipment to help you reach your full potential.</p>
            <button className="bg-[#FA0403] py-2 h-[54px] text-[18px] semibold px-8 rounded-md text-white mt-5"><a href="/AboutUs">Know More About Us</a></button>
